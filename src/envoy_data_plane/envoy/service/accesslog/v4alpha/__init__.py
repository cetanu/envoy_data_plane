...
# sources: envoy/service/accesslog/v4alpha/als.proto
...
class StreamAccessLogsMessageIdentifier(betterproto.Message):
    ...
    # <envoy_api_msg_extensions.access_loggers.grpc.v4alpha.CommonGrpcAccessLogCo
    # nfig>`.
...
class AccessLogServiceStub(betterproto.ServiceStub):
    async def stream_access_logs(
        ...
        return await self._stream_unary(
            "/envoy.service.accesslog.v4alpha.AccessLogService/StreamAccessLogs",
            request_iterator,
...
class AccessLogServiceBase(ServiceBase):
    ...
    def __mapping__(self) -> Dict[str, grpclib.const.Handler]:
        return {
            "/envoy.service.accesslog.v4alpha.AccessLogService/StreamAccessLogs": grpclib.const.Handler(
