...
# sources: envoy/service/event_reporting/v4alpha/event_reporting_service.proto
...
class EventReportingServiceStub(betterproto.ServiceStub):
    async def stream_events(
        ...
        async for response in self._stream_stream(
            "/envoy.service.event_reporting.v4alpha.EventReportingService/StreamEvents",
            request_iterator,
            StreamEventsRequest,
...
class EventReportingServiceBase(ServiceBase):
    ...
    def __mapping__(self) -> Dict[str, grpclib.const.Handler]:
        return {
            "/envoy.service.event_reporting.v4alpha.EventReportingService/StreamEvents": grpclib.const.Handler(
