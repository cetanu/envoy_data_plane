...
class OkHttpResponse(betterproto.Message):
    ...
    # from the original request before dispatching it to the upstream. By setting
    # `append` field to `true` in the `HeaderValueOption`, the filter will append
    # the correspondent header value to the matched request header. Note that by
