...
# sources: envoy/service/status/v4alpha/csds.proto
...
class ClientStatusRequest(betterproto.Message):
    ...
    node_matchers: List[
        "___type_matcher_v4_alpha__.NodeMatcher"
...
class PerXdsConfig(betterproto.Message):
    ...
    listener_config: "___admin_v4_alpha__.ListenersConfigDump" = (
        betterproto.message_field(2, group="per_xds_config")
    )
    cluster_config: "___admin_v4_alpha__.ClustersConfigDump" = (
        betterproto.message_field(3, group="per_xds_config")
    )
    route_config: "___admin_v4_alpha__.RoutesConfigDump" = betterproto.message_field(
        4, group="per_xds_config"
    )
    scoped_route_config: "___admin_v4_alpha__.ScopedRoutesConfigDump" = (
        betterproto.message_field(5, group="per_xds_config")
    )
    endpoint_config: "___admin_v4_alpha__.EndpointsConfigDump" = (
        betterproto.message_field(6, group="per_xds_config")
    )
...
class ClientConfigGenericXdsConfig(betterproto.Message):
    ...
    client_status: "___admin_v4_alpha__.ClientResourceStatus" = betterproto.enum_field(
        7
    )
    ...
    error_state: "___admin_v4_alpha__.UpdateFailureState" = betterproto.message_field(8)
...
class ClientStatusDiscoveryServiceStub(betterproto.ServiceStub):
    async def stream_client_status(
        ...
        async for response in self._stream_stream(
            "/envoy.service.status.v4alpha.ClientStatusDiscoveryService/StreamClientStatus",
            request_iterator,
            ClientStatusRequest,
    ...
    async def fetch_client_status(
        self,
        *,
        node_matchers: Optional[List["___type_matcher_v4_alpha__.NodeMatcher"]] = None,
        node: "___config_core_v4_alpha__.Node" = None,
    ) -> "ClientStatusResponse":
        ...
        return await self._unary_unary(
            "/envoy.service.status.v4alpha.ClientStatusDiscoveryService/FetchClientStatus",
            request,
            ClientStatusResponse,
        )
...
class ClientStatusDiscoveryServiceBase(ServiceBase):
    ...
    async def fetch_client_status(
        self,
        node_matchers: Optional[List["___type_matcher_v4_alpha__.NodeMatcher"]],
        node: "___config_core_v4_alpha__.Node",
    ) -> "ClientStatusResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    def __mapping__(self) -> Dict[str, grpclib.const.Handler]:
        return {
            "/envoy.service.status.v4alpha.ClientStatusDiscoveryService/StreamClientStatus": grpclib.const.Handler(
                self.__rpc_stream_client_status,
                grpclib.const.Cardinality.STREAM_STREAM,
                ClientStatusRequest,
                ClientStatusResponse,
            ),
            "/envoy.service.status.v4alpha.ClientStatusDiscoveryService/FetchClientStatus": grpclib.const.Handler(
...
from ....admin import v4alpha as ___admin_v4_alpha__
