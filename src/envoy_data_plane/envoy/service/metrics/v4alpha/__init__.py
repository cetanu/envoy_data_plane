...
# sources: envoy/service/metrics/v4alpha/metrics_service.proto
...
class MetricsServiceStub(betterproto.ServiceStub):
    async def stream_metrics(
        ...
        return await self._stream_unary(
            "/envoy.service.metrics.v4alpha.MetricsService/StreamMetrics",
            request_iterator,
...
class MetricsServiceBase(ServiceBase):
    ...
    def __mapping__(self) -> Dict[str, grpclib.const.Handler]:
        return {
            "/envoy.service.metrics.v4alpha.MetricsService/StreamMetrics": grpclib.const.Handler(
