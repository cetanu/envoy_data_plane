...
# sources: envoy/service/load_stats/v4alpha/lrs.proto
...
class LoadReportingServiceStub(betterproto.ServiceStub):
    async def stream_load_stats(
        ...
        async for response in self._stream_stream(
            "/envoy.service.load_stats.v4alpha.LoadReportingService/StreamLoadStats",
            request_iterator,
            LoadStatsRequest,
            LoadStatsResponse,
        ):
...
class LoadReportingServiceBase(ServiceBase):
    ...
    def __mapping__(self) -> Dict[str, grpclib.const.Handler]:
        return {
            "/envoy.service.load_stats.v4alpha.LoadReportingService/StreamLoadStats": grpclib.const.Handler(
