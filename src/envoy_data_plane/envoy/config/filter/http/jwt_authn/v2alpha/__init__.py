...
class JwtProvider(betterproto.Message):
    ...
    # base64_encoded(jwt_payload_in_JSON) If it is not specified, the payload
...
class JwtAuthentication(betterproto.Message):
    ...
    # rules:   - match:       prefix: /healthz   - match:       prefix: /baz
    # requires:       provider_name: provider1   - match:       prefix: /foo
    # requires:       requires_any:         requirements:           -
    # provider_name: provider1           - provider_name: provider2   - match:
    # prefix: /bar     requires:       requires_all:         requirements:
    # - provider_name: provider1           - provider_name: provider2
