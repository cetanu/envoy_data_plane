...
# sources: envoy/config/core/v3/address.proto, envoy/config/core/v3/base.proto, envoy/config/core/v3/config_source.proto, envoy/config/core/v3/grpc_service.proto, envoy/config/core/v3/health_check.proto, envoy/config/core/v3/http_uri.proto, envoy/config/core/v3/protocol.proto
...
class HttpProtocolOptions(betterproto.Message):
    ...
    # ield_extensions.filters.network.http_connection_manager.v3.HttpConnectionMa
    # nager.drain_timeout>`. Note that request based timeouts mean that HTTP/2
    # PINGs will not keep the connection alive. If not specified, this defaults
    # to 1 hour. To disable idle timeouts explicitly set this to 0. .. warning::
