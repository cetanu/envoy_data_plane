...
class HttpProtocolOptions(betterproto.Message):
    ...
    # :ref:`HTTP_DOWNSTREAM_CONNECTION_IDLE <envoy_api_enum_value_config.overload
    # .v3.ScaleTimersOverloadActionConfig.TimerType.HTTP_DOWNSTREAM_CONNECTION_ID
    # LE>`.
...
class Http3ProtocolOptions(betterproto.Message):
    """[#not-implemented-hide:] A message which allows using HTTP/3."""
