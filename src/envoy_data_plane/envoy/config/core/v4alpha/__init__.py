...
class Http2ProtocolOptions(betterproto.Message):
    ...
    # default limit is 100. NOTE: flood and abuse mitigation for upstream
    # connections is presently enabled by the
    # `envoy.reloadable_features.upstream_http2_flood_checks` flag.
    ...
    # available bandwidth require at least 2. NOTE: flood and abuse mitigation
    # for upstream connections is presently enabled by the
    # `envoy.reloadable_features.upstream_http2_flood_checks` flag.
...
class SubstitutionFormatString(betterproto.Message):
    ...
    plain text or JSON format. [#next-free-field: 6]
    """
