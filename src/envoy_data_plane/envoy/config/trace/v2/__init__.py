...
# sources: envoy/config/trace/v2/trace.proto
...
class Tracing(betterproto.Message):
    ...
    <envoy_api_msg_config.bootstrap.v2.Bootstrap>` :ref:`tracing
    <envoy_api_field_config.bootstrap.v2.Bootstrap.tracing>` field. Envoy may
