...
class OutlierDetection(betterproto.Message):
    ...
    # is capped by :ref:`max_ejection_time<envoy_api_field_config.cluster.v4alpha
    # .OutlierDetection.max_ejection_time>`. Defaults to 30000ms or 30s.
    ...
    # nvoy_api_field_config.cluster.v4alpha.OutlierDetection.base_ejection_time>`
    # for more information. If not specified, the default value (300000ms or
    # 300s) or :ref:`base_ejection_time<envoy_api_field_config.cluster.v4alpha.Ou
    # tlierDetection.base_ejection_time>` value is applied, whatever is larger.
