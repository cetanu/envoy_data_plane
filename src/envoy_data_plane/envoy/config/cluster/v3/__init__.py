...
class Cluster(betterproto.Message):
    ...
    # metadata value under *envoy.transport_socket* having "acceptMTLS"/"true"
    # key/value pair use the "enableMTLS" socket configuration. If a :ref:`socket
    # match <envoy_api_msg_config.cluster.v3.Cluster.TransportSocketMatch>` with
    ...
    # endpoint metadata's value under *envoy.transport_socket* does not match any
    ...
    # ignored. Note: Currently, DNS failures and empty DNS responses are not
    # treated differently and this configuration is applied in both situations.
