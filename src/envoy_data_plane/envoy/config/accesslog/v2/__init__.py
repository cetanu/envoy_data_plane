...
class FileAccessLog(betterproto.Message):
    ...
    entries directly to a file. Configures the built-in *envoy.file_access_log*
    AccessLog.
    """
...
class HttpGrpcAccessLogConfig(betterproto.Message):
    """
    Configuration for the built-in *envoy.http_grpc_access_log* :ref:`AccessLog
    <envoy_api_msg_config.filter.accesslog.v2.AccessLog>`. This configuration
...
class TcpGrpcAccessLogConfig(betterproto.Message):
    """
    Configuration for the built-in *envoy.tcp_grpc_access_log* type. This
