...
class Matcher(betterproto.Message):
    ...
    until the final OnMatch (or no match) is decided. This API is a work in
    progress.
    """
...
class MatcherOnMatch(betterproto.Message):
    ...
    action: "___core_v4_alpha__.TypedExtensionConfig" = betterproto.message_field(
        2, group="on_match"
    )
...
class MatcherMatcherListPredicateSinglePredicate(betterproto.Message):
    ...
    input: "___core_v4_alpha__.TypedExtensionConfig" = betterproto.message_field(1)
    # Built-in string matcher.
    value_match: "____type_matcher_v4_alpha__.StringMatcher" = (
        betterproto.message_field(2, group="matcher")
    )
    # Extension for custom matching logic.
    custom_match: "___core_v4_alpha__.TypedExtensionConfig" = betterproto.message_field(
        3, group="matcher"
    )
...
from ....core import v4alpha as ___core_v4_alpha__
