...
# sources: envoy/config/listener/v4alpha/api_listener.proto, envoy/config/listener/v4alpha/listener.proto, envoy/config/listener/v4alpha/listener_components.proto, envoy/config/listener/v4alpha/quic_config.proto, envoy/config/listener/v4alpha/udp_listener_config.proto
...
class QuicProtocolOptions(betterproto.Message):
    ...
    quic_protocol_options: "__core_v4_alpha__.QuicProtocolOptions" = (
...
class Filter(betterproto.Message):
    ...
    config_discovery: "__core_v4_alpha__.ExtensionConfigSource" = (
...
class FilterChain(betterproto.Message):
    ...
    # plaintext. [#extension-category: envoy.transport_sockets.downstream]
...
class UdpListenerConfig(betterproto.Message):
    ...
    # performance testing.
    downstream_socket_config: "__core_v4_alpha__.UdpSocketConfig" = (
...
class Listener(betterproto.Message):
    ...
    # :ref:`address <envoy_api_field_config.listener.v4alpha.Listener.address>`
    # has field `envoy_internal_address`. There are some limitations are derived
    # from the implementation. The known limitations include *
    # :ref:`ConnectionBalanceConfig
    # <envoy_api_msg_config.listener.v4alpha.Listener.ConnectionBalanceConfig>`
    # is not   allowed because both cluster connection and listener connection
    # must be owned by the same dispatcher. * :ref:`tcp_backlog_size
    # <envoy_api_field_config.listener.v4alpha.Listener.tcp_backlog_size>` *
    # :ref:`freebind <envoy_api_field_config.listener.v4alpha.Listener.freebind>`
    # * :ref:`transparent
    # <envoy_api_field_config.listener.v4alpha.Listener.transparent>` [#not-
    # implemented-hide:]
