...
# sources: envoy/config/metrics/v4alpha/metrics_service.proto, envoy/config/metrics/v4alpha/stats.proto
...
class HistogramBucketSettings(betterproto.Message):
    ...
    match: "___type_matcher_v4_alpha__.StringMatcher" = betterproto.message_field(1)
...
class StatsdSink(betterproto.Message):
    ...
    # address.
    address: "__core_v4_alpha__.Address" = betterproto.message_field(
...
class MetricsServiceConfig(betterproto.Message):
    ...
    *envoy.stat_sinks.metrics_service* :ref:`StatsSink
    ...
    transport_api_version: "__core_v4_alpha__.ApiVersion" = betterproto.enum_field(3)
