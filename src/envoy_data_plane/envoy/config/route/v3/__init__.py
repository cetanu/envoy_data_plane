...
class VirtualHost(betterproto.Message):
    ...
    # :ref:`FilterConfig<envoy_api_msg_config.route.v3.FilterConfig>` message to
...
class HedgePolicy(betterproto.Message):
    ...
    # must have a :ref:`RetryPolicy <envoy_api_msg_config.route.v3.RetryPolicy>`
    # that retries at least one error code and specifies a maximum number of
    # retries. Defaults to false.
...
class RateLimitAction(betterproto.Message):
    ...
    # <envoy_api_field_config.route.v3.RateLimit.Action.metadata>` field
...
class RateLimitActionDynamicMetaData(betterproto.Message):
    ...
    :ref:`metadata <envoy_api_msg_config.route.v3.RateLimit.Action.MetaData>`
    action
    """
...
class FilterConfig(betterproto.Message):
    ...
    voy_api_field_config.route.v3.VirtualHost.typed_per_filter_config>`, :ref:`
    Route.typed_per_filter_config<envoy_api_field_config.route.v3.Route.typed_p
    er_filter_config>`, or :ref:`WeightedCluster.ClusterWeight.typed_per_filter
    _config<envoy_api_field_config.route.v3.WeightedCluster.ClusterWeight.typed
    _per_filter_config>` to add additional flags to the filter. [#not-
    implemented-hide:]
    """
...
class RouteConfiguration(betterproto.Message):
    ...
    # <envoy_api_field_config.route.v3.DirectResponseAction.body>` size. If not
    # specified the default is 4096. .. warning::   Envoy currently holds the
    # content of :ref:`direct response body
    # <envoy_api_field_config.route.v3.DirectResponseAction.body>` in memory. Be
    # careful setting   this to be larger than the default 4KB, since the
