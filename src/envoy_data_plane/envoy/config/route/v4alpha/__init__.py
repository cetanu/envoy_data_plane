...
class HedgePolicy(betterproto.Message):
    ...
    # <envoy_api_msg_config.route.v4alpha.RetryPolicy>` that retries at least one
...
class RateLimitActionDynamicMetaData(betterproto.Message):
    ...
    :ref:`metadata
    <envoy_api_msg_config.route.v4alpha.RateLimit.Action.MetaData>` action
    """
...
class FilterConfig(betterproto.Message):
    ...
    voy_api_field_config.route.v4alpha.VirtualHost.typed_per_filter_config>`, :
    ref:`Route.typed_per_filter_config<envoy_api_field_config.route.v4alpha.Rou
    te.typed_per_filter_config>`, or :ref:`WeightedCluster.ClusterWeight.typed_
    per_filter_config<envoy_api_field_config.route.v4alpha.WeightedCluster.Clus
    terWeight.typed_per_filter_config>` to add additional flags to the filter.
...
class RouteConfiguration(betterproto.Message):
    ...
    # <envoy_api_field_config.route.v4alpha.DirectResponseAction.body>` size. If
    # not specified the default is 4096. .. warning::   Envoy currently holds the
    # content of :ref:`direct response body
    # <envoy_api_field_config.route.v4alpha.DirectResponseAction.body>` in
    # memory. Be careful setting   this to be larger than the default 4KB, since
    # the allocated memory for direct response body   is not subject to data
    # plane buffering controls.
