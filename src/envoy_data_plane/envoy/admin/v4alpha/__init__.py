...
# sources: envoy/admin/v4alpha/certs.proto, envoy/admin/v4alpha/clusters.proto, envoy/admin/v4alpha/config_dump.proto, envoy/admin/v4alpha/init_dump.proto, envoy/admin/v4alpha/listeners.proto, envoy/admin/v4alpha/memory.proto, envoy/admin/v4alpha/metrics.proto, envoy/admin/v4alpha/mutex_stats.proto, envoy/admin/v4alpha/server_info.proto, envoy/admin/v4alpha/tap.proto
...
class HostStatus(betterproto.Message):
    ...
    address: "__config_core_v4_alpha__.Address" = betterproto.message_field(1)
    ...
    locality: "__config_core_v4_alpha__.Locality" = betterproto.message_field(9)
...
class HostHealthStatus(betterproto.Message):
    ...
    eds_health_status: "__config_core_v4_alpha__.HealthStatus" = betterproto.enum_field(
        3
    )
...
class BootstrapConfigDump(betterproto.Message):
    ...
    bootstrap: "__config_bootstrap_v4_alpha__.Bootstrap" = betterproto.message_field(1)
...
class ServerInfo(betterproto.Message):
    ...
    node: "__config_core_v4_alpha__.Node" = betterproto.message_field(7)
...
class TapRequest(betterproto.Message):
    ...
    tap_config: "__config_tap_v4_alpha__.TapConfig" = betterproto.message_field(2)
...
class ListenerStatus(betterproto.Message):
    ...
    # allocated by the OS.
    local_address: "__config_core_v4_alpha__.Address" = betterproto.message_field(2)
...
from ...config.bootstrap import v4alpha as __config_bootstrap_v4_alpha__
from ...config.cluster import v4alpha as __config_cluster_v4_alpha__
from ...config.core import v4alpha as __config_core_v4_alpha__
from ...config.tap import v4alpha as __config_tap_v4_alpha__
