...
# sources: envoy/admin/v3/certs.proto, envoy/admin/v3/clusters.proto, envoy/admin/v3/config_dump.proto, envoy/admin/v3/listeners.proto, envoy/admin/v3/memory.proto, envoy/admin/v3/metrics.proto, envoy/admin/v3/mutex_stats.proto, envoy/admin/v3/server_info.proto, envoy/admin/v3/tap.proto
...
class ClusterStatus(betterproto.Message):
    ...
    # ction.split_external_local_origin_errors<envoy_api_field_config.cluster.v3.
    # OutlierDetection.split_external_local_origin_errors>` is *false*, all
    ...
    # voy_api_field_config.cluster.v3.OutlierDetection.split_external_local_origi
    # n_errors>` is *true*, only externally generated errors were used to
    ...
    # config.cluster.v3.OutlierDetection.split_external_local_origin_errors>` is
    # *true*. The threshold is used to eject hosts based on their success rate.
    # See :ref:`Cluster outlier detection <arch_overview_outlier_detection>`
...
class HostStatus(betterproto.Message):
    ...
    # rors<envoy_api_field_config.cluster.v3.OutlierDetection.split_external_loca
    # l_origin_errors>` is *true*, only externally generated errors were used in
    # success rate calculation. See :ref:`Cluster outlier detection
    ...
    # api_field_config.cluster.v3.OutlierDetection.split_external_local_origin_er
    # rors>` is *true*. See :ref:`Cluster outlier detection
    # <arch_overview_outlier_detection>` documentation for details. Note: the
    # message will not be present if host did not have enough request volume to
    # calculate success rate or the cluster did not have enough hosts to run
    # through success rate outlier ejection.
...
class ConfigDump(betterproto.Message):
    ...
    # <envoy_api_msg_admin.v3.ListenersConfigDump>` * *routes*:
    # :ref:`RoutesConfigDump <envoy_api_msg_admin.v3.RoutesConfigDump>` You can
...
class RoutesConfigDump(betterproto.Message):
    ...
    configured in the bootstrap configuration are separated from those
    configured dynamically via RDS. Route configuration information can be used
    to recreate an Envoy configuration by populating all routes as static
    routes or by returning them in RDS responses.
    """
