...
# sources: envoy/extensions/filters/http/gzip/v4alpha/gzip.proto
...
class Gzip(betterproto.Message):
    ...
    compressor: "__compressor_v4_alpha__.Compressor" = betterproto.message_field(10)
...
from ...compressor import v4alpha as __compressor_v4_alpha__
