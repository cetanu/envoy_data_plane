...
class LocalRateLimit(betterproto.Message):
    ...
    # global :ref:`token bucket's<envoy_api_field_extensions.filters.http.local_r
    # atelimit.v3.LocalRateLimit.token_bucket>` fill interval.   The descriptors
    # must match verbatim for rate limiting to apply. There is no partial   match
    # by a subset of descriptor entries in the current implementation.
    descriptors: List[
