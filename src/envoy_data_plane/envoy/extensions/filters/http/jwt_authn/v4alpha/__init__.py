...
# sources: envoy/extensions/filters/http/jwt_authn/v4alpha/config.proto
...
class JwtProvider(betterproto.Message):
    ...
    seconds: 300 [#next-free-field: 11]
    """
    ...
    local_jwks: "_____config_core_v4_alpha__.DataSource" = betterproto.message_field(
