...
class HttpFault(betterproto.Message):
    ...
    # <envoy_api_field_extensions.filters.http.fault.v3.FaultAbort.percentage>`
    # field. The filter will check the request's headers against all the
    # specified headers in the filter config. A match will happen if all the
    # headers in the config are present in the request with the same values (or
