...
# sources: envoy/extensions/filters/network/thrift_proxy/filters/ratelimit/v4alpha/rate_limit.proto
...
class RateLimit(betterproto.Message):
    ...
    # :`envoy_api_msg_extensions.filters.network.thrift_proxy.v4alpha.RouteAction
    ...
    # success.
    rate_limit_service: "_______config_ratelimit_v4_alpha__.RateLimitServiceConfig" = (
        betterproto.message_field(5)
    )


from ........config.ratelimit import v4alpha as _______config_ratelimit_v4_alpha__
