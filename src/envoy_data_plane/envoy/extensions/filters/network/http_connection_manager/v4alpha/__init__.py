...
# sources: envoy/extensions/filters/network/http_connection_manager/v4alpha/http_connection_manager.proto
...
class HttpConnectionManager(betterproto.Message):
    ...
    # this property.
    route_config: "_____config_route_v4_alpha__.RouteConfiguration" = (
    ...
    common_http_protocol_options: "_____config_core_v4_alpha__.HttpProtocolOptions" = (
        betterproto.message_field(35)
    )
    # Additional HTTP/1 settings that are passed to the HTTP/1 codec.
    http_protocol_options: "_____config_core_v4_alpha__.Http1ProtocolOptions" = (
    ...
    # tocolOptions.max_stream_duration>` does not apply to this corner case. If
    # the :ref:`overload action <config_overload_manager_overload_actions>`
...
class HttpConnectionManagerTracing(betterproto.Message):
    ...
    provider: "_____config_trace_v4_alpha__.TracingHttp" = betterproto.message_field(9)
...
class HttpConnectionManagerPathNormalizationOptions(betterproto.Message):
    ...
    <envoy_api_field_config.route.v4alpha.RouteAction.regex_rewrite>` or
    :ref:`prefix_rewrite
    <envoy_api_field_config.route.v4alpha.RouteAction.prefix_rewrite>`) will
...
class LocalReplyConfig(betterproto.Message):
    ...
    body_format: "_____config_core_v4_alpha__.SubstitutionFormatString" = (
        betterproto.message_field(2)
    )
...
class ResponseMapper(betterproto.Message):
    ...
    filter: "_____config_accesslog_v4_alpha__.AccessLogFilter" = (
        betterproto.message_field(1)
    )
    ...
    body: "_____config_core_v4_alpha__.DataSource" = betterproto.message_field(3)
    ...
    body_format_override: "_____config_core_v4_alpha__.SubstitutionFormatString" = (
...
class Rds(betterproto.Message):
    ...
    config_source: "_____config_core_v4_alpha__.ConfigSource" = (
        betterproto.message_field(1)
    )
...
class ScopedRouteConfigurationsList(betterproto.Message):
    ...
    scoped_route_configurations: List[
        "_____config_route_v4_alpha__.ScopedRouteConfiguration"
    ] = betterproto.message_field(1)
...
class ScopedRoutes(betterproto.Message):
    ...
    rds_config_source: "_____config_core_v4_alpha__.ConfigSource" = (
...
class HttpFilter(betterproto.Message):
    ...
    # <envoy_api_msg_extensions.common.matching.v4alpha.ExtensionWithMatcher>`
    # with the desired HTTP filter. [#extension-category: envoy.filters.http]
    ...
    # <envoy_api_msg_extensions.common.matching.v4alpha.ExtensionWithMatcher>`
    # with the desired HTTP filter. This works for both the default filter
