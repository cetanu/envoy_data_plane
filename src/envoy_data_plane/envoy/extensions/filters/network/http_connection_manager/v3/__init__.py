...
class HttpConnectionManager(betterproto.Message):
    ...
    # .. note::    This field is deprecated and instead
    # :ref:`original_ip_detection_extensions    <envoy_v3_api_field_extensions.fi
    # lters.network.http_connection_manager.v3.HttpConnectionManager.original_ip_
    # detection_extensions>`    should be used to configure the :ref:`xff
    # extension
    # <envoy_v3_api_msg_extensions.http.original_ip_detection.xff.v3.XffConfig>`
    # to configure IP detection using the :ref:`config_http_conn_man_headers_x-
    # forwarded-for` header. To replace    this field use a config like the
    # following: .. code-block:: yaml    original_ip_detection_extensions:
    # typed_config:        "@type": type.googleapis.com/envoy.extensions.http.ori
    # ginal_ip_detection.xff.v3.XffConfig        xff_num_trusted_hops: 1
    ...
    def __post_init__(self) -> None:
        super().__post_init__()
        if self.xff_num_trusted_hops:
            warnings.warn(
                "HttpConnectionManager.xff_num_trusted_hops is deprecated",
                DeprecationWarning,
            )
