...
# sources: envoy/extensions/filters/network/ratelimit/v4alpha/rate_limit.proto
...
class RateLimit(betterproto.Message):
    ...
    # success.
    rate_limit_service: "_____config_ratelimit_v4_alpha__.RateLimitServiceConfig" = (
        betterproto.message_field(6)
    )


from ......config.ratelimit import v4alpha as _____config_ratelimit_v4_alpha__
