...
# sources: envoy/extensions/filters/network/rbac/v4alpha/rbac.proto
...
class Rbac(betterproto.Message):
    ...
    rules: "_____config_rbac_v4_alpha__.Rbac" = betterproto.message_field(1)
    # Shadow rules are not enforced by the filter but will emit stats and logs
    # and can be used for rule testing. If absent, no shadow RBAC policy will be
    # applied.
    shadow_rules: "_____config_rbac_v4_alpha__.Rbac" = betterproto.message_field(2)
...
from ......config.rbac import v4alpha as _____config_rbac_v4_alpha__
