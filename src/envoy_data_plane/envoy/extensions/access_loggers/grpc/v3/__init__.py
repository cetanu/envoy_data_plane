...
class CommonGrpcAccessLogConfig(betterproto.Message):
    ...
    # stream succeeds once in establishing If the stream succeeds at least once
    # in establishing itself, no retry will be performed no matter what gRPC
    # status is received. Note that only :ref:`num_retries
