...
# sources: envoy/extensions/access_loggers/grpc/v4alpha/als.proto
...
class HttpGrpcAccessLogConfig(betterproto.Message):
    ...
    api_field_service.accesslog.v4alpha.StreamAccessLogsMessage.http_logs>`.
...
class CommonGrpcAccessLogConfig(betterproto.Message):
    ...
    # :ref:`StreamAccessLogsMessage.Identifier <envoy_api_msg_service.accesslog.v
    # 4alpha.StreamAccessLogsMessage.Identifier>`. This allows the access log
    ...
    transport_api_version: "____config_core_v4_alpha__.ApiVersion" = (
