...
# sources: envoy/extensions/common/dynamic_forward_proxy/v4alpha/dns_cache.proto
...
class DnsCacheConfig(betterproto.Message):
    ...
    dns_lookup_family: "____config_cluster_v4_alpha__.ClusterDnsLookupFamily" = (
    ...
    dns_failure_refresh_rate: "____config_cluster_v4_alpha__.ClusterRefreshRate" = (
    ...
    dns_resolution_config: "____config_core_v4_alpha__.DnsResolutionConfig" = (
    ...
    preresolve_hostnames: List[
        "____config_core_v4_alpha__.SocketAddress"
...
from .....config.cluster import v4alpha as ____config_cluster_v4_alpha__
