...
# sources: envoy/extensions/transport_sockets/tls/v3/cert.proto
...
class CertificateValidationContext(betterproto.Message):
    ...
    # revoked by one of the included CRLs. See :ref:`the TLS overview
    ...
    # option must be used together with :ref:`trusted_ca   <envoy_api_field_exten
    # sions.transport_sockets.tls.v3.CertificateValidationContext.trusted_ca>`.
