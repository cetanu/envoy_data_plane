...
# sources: envoy/extensions/transport_sockets/tls/v4alpha/common.proto, envoy/extensions/transport_sockets/tls/v4alpha/secret.proto, envoy/extensions/transport_sockets/tls/v4alpha/tls.proto, envoy/extensions/transport_sockets/tls/v4alpha/tls_spiffe_validator_config.proto
...
class TlsCertificate(betterproto.Message):
    ...
    watched_directory: "____config_core_v4_alpha__.WatchedDirectory" = (
...
class CertificateValidationContext(betterproto.Message):
    ...
    custom_validator_config: "____config_core_v4_alpha__.TypedExtensionConfig" = (
...
class SpiffeCertValidatorConfig(betterproto.Message):
    ...
    ort_sockets.tls.v4alpha.CertificateValidationContext.allow_expired_certific
    ate>` to allow expired certificates. - :ref:`match_subject_alt_names <envoy
    _api_field_extensions.transport_sockets.tls.v4alpha.CertificateValidationCo
    ntext.match_subject_alt_names>` to match **URI** SAN of certificates.
...
class SpiffeCertValidatorConfigTrustDomain(betterproto.Message):
    ...
    trust_bundle: "____config_core_v4_alpha__.DataSource" = betterproto.message_field(2)
