...
class Fixed32Rules(betterproto.Message):
    ...
    # Lt specifies that this field must be less than the specified value,
    # exclusive
    lt: float = betterproto.fixed32_field(2)
    # Lte specifies that this field must be less than or equal to the specified
    # value, inclusive
    lte: float = betterproto.fixed32_field(3)
    # Gt specifies that this field must be greater than the specified value,
    # exclusive. If the value of Gt is larger than a specified Lt or Lte, the
    # range is reversed.
    gt: float = betterproto.fixed32_field(4)
    # Gte specifies that this field must be greater than or equal to the
    # specified value, inclusive. If the value of Gte is larger than a specified
    # Lt or Lte, the range is reversed.
    gte: float = betterproto.fixed32_field(5)
    # In specifies that this field must be equal to one of the specified values
...
class Fixed64Rules(betterproto.Message):
    ...
    # Lt specifies that this field must be less than the specified value,
    # exclusive
    lt: float = betterproto.fixed64_field(2)
    # Lte specifies that this field must be less than or equal to the specified
    # value, inclusive
    lte: float = betterproto.fixed64_field(3)
    # Gt specifies that this field must be greater than the specified value,
    # exclusive. If the value of Gt is larger than a specified Lt or Lte, the
    # range is reversed.
    gt: float = betterproto.fixed64_field(4)
    # Gte specifies that this field must be greater than or equal to the
    # specified value, inclusive. If the value of Gte is larger than a specified
    # Lt or Lte, the range is reversed.
    gte: float = betterproto.fixed64_field(5)
    # In specifies that this field must be equal to one of the specified values
...
class SFixed32Rules(betterproto.Message):
    ...
    # Lt specifies that this field must be less than the specified value,
    # exclusive
    lt: float = betterproto.sfixed32_field(2)
    # Lte specifies that this field must be less than or equal to the specified
    # value, inclusive
    lte: float = betterproto.sfixed32_field(3)
    # Gt specifies that this field must be greater than the specified value,
    # exclusive. If the value of Gt is larger than a specified Lt or Lte, the
    # range is reversed.
    gt: float = betterproto.sfixed32_field(4)
    # Gte specifies that this field must be greater than or equal to the
    # specified value, inclusive. If the value of Gte is larger than a specified
    # Lt or Lte, the range is reversed.
    gte: float = betterproto.sfixed32_field(5)
    # In specifies that this field must be equal to one of the specified values
...
class SFixed64Rules(betterproto.Message):
    ...
    # Lt specifies that this field must be less than the specified value,
    # exclusive
    lt: float = betterproto.sfixed64_field(2)
    # Lte specifies that this field must be less than or equal to the specified
    # value, inclusive
    lte: float = betterproto.sfixed64_field(3)
    # Gt specifies that this field must be greater than the specified value,
    # exclusive. If the value of Gt is larger than a specified Lt or Lte, the
    # range is reversed.
    gt: float = betterproto.sfixed64_field(4)
    # Gte specifies that this field must be greater than or equal to the
    # specified value, inclusive. If the value of Gte is larger than a specified
    # Lt or Lte, the range is reversed.
    gte: float = betterproto.sfixed64_field(5)
    # In specifies that this field must be equal to one of the specified values
